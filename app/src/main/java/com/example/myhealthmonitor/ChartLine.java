...
public class ChartLine {
    ...
    public ChartLine(ImageView container, Context context){
    ...
    public void setData(Cursor cursorPA, Cursor cursorG, Cursor cursorW, Cursor cursorP, Cursor cursorO, Cursor cursorT, String firstDay, String lastDay){
        max=0;
